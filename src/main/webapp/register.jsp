...
%>
    <div id="message-box" 
         class="alert <%= errorMessage != null ? "alert-danger" : "alert-success" %>" 
         role="alert">
        <%= errorMessage != null ? errorMessage : success %>
    </div>
...
<form action="register" method="post">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Name"  required="required" name="fname">
  </div>
